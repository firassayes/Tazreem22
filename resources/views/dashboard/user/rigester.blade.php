                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form action="{{ route('user.create') }}" method="post" autocomplete="off">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="register-email" type="text" name="email"
                                            placeholder="example@example.com" aria-describedby="register-email"
                                            tabindex="2" />
                                    ...
                                    <div class="mb-1">
                                        <div class="form-check">
                                            <input class="form-check-input" id="register-privacy-policy" type="checkbox"
                                                tabindex="4" />
                                            <label class="form-check-label" for="register-privacy-policy">I agree
                                                to<a href="#">&nbsp;privacy policy & terms</a></label>
                                        </div>
                                    </div>
                                ...
                                <p class="text-center mt-2"><span>Already have an account?</span><a
                                        href="{{ route('user.login') }}"><span>&nbsp;Sign in instead</span></a></p>
